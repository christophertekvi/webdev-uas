       ...
       <form action="/sign-up" method="post">
        ...
        <div class="controlnamadepanbelakang">
          ...
          <div class="datainputsignup">
            ...
            <input type="password" placeholder="min. 5 characters" name="password" id="inputPassword5" class="form-control @error('password')is-invalid @enderror"  aria-describedby="passwordHelpBlock" required>
            @error('password')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
          ...
          <div class="datainputsignup">
            ...
            <input type="password" placeholder="min. 5 characters" name="reenterpassword" id="inputPassword6" class="form-control @error('reenterpassword')is-invalid @enderror"  aria-describedby="passwordHelpBlock" required>
